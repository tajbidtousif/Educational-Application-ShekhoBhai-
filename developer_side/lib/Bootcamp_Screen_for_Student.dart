...
class Bootcamp_Screen_for_Student extends StatefulWidget {
  const Bootcamp_Screen_for_Student({Key? key}) : super(key: key);

  @override
  State<Bootcamp_Screen_for_Student> createState() => _Bootcamp_Screen_for_StudentState();
}

class _Bootcamp_Screen_for_StudentState extends State<Bootcamp_Screen_for_Student> {
