...
class WebDevelopmentPlaylist extends StatefulWidget {
  const WebDevelopmentPlaylist({super.key});

  @override
  State<WebDevelopmentPlaylist> createState() => _WebDevelopmentPlaylistState();
}

class _WebDevelopmentPlaylistState extends State<WebDevelopmentPlaylist> {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: WebView(
          ...
          initialUrl: 'https://youtube.com/playlist?list=PLgH5QX0i9K3p06YY1fyReA2UK8mh_zsiY',
        ),
      ),
    );
