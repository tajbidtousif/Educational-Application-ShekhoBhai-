...
class ComputerGraphics extends StatefulWidget {
  const ComputerGraphics({super.key});

  @override
  State<ComputerGraphics> createState() => _ComputerGraphicsState();
}

class _ComputerGraphicsState extends State<ComputerGraphics> {
