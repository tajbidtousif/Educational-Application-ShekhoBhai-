...
class Add_bootcamp_news extends StatefulWidget {
  const Add_bootcamp_news({Key? key}) : super(key: key);

  @override
  State<Add_bootcamp_news> createState() => _Add_bootcamp_newsState();
}

class _Add_bootcamp_newsState extends State<Add_bootcamp_news> {
  bool showSpinner = false;
  final postRef = FirebaseDatabase.instance.ref().child('BootCampNews');
                    ...
                    children: [
                      TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: 'Title',
                          hintText: 'Enter Boot-Camp title',
                ...
                ElevatedButton(
                  onPressed: ()async{
                    ...
                    try{
                      ...
                      firebase_storage.Reference ref = firebase_storage.FirebaseStorage.instance.ref('BootCampNews/$date');
                      ...
                      postRef.child("Boot Camp News List").child(date.toString()).set({
                        "pId": date.toString(),
                        "pTime": date.toString(),
